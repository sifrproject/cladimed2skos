...
public class CladimedConverter {
	...
	public static final String OWL_DEPRECATED = "<owl:deprecated>true</owl:deprecated>";
	...
	public void execute(){
		...
		System.out.println();
		System.out.println("Simple Classif Begin conversion...");
		processSimpleClassification();
		System.out.println("Done...");
		
		//Complete Classification
		System.out.println();
		System.out.println("Complete Classif Begin conversion...");
		processCompleteClassification();
		System.out.println("Done...");
